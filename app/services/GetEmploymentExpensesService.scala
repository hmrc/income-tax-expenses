...
import connectors.GetEmploymentExpensesConnector
...
class GetEmploymentExpensesService @Inject()(connector: GetEmploymentExpensesConnector) {
  ...
  def getEmploymentExpenses(nino: String, taxYear: Int, view: String)(implicit hc: HeaderCarrier): Future[GetEmploymentExpensesResponse] =
    connector.getEmploymentExpenses(nino, taxYear, view)
